...
def main():
    ...
    if not tester_branch and not documenter_branch and not verifier_branch:
    ...
    removable_branches = [b for b in [verifier_branch, documenter_branch, tester_branch] if b]
