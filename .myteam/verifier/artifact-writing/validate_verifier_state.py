...
ALLOWED_ARTIFACTS = {"verifier_report.md", "verifier_result.json"}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate final verifier artifact state before commit.")
    parser.add_argument("--repo-root", default=".", help="Repository root or worktree root.")
    parser.add_argument("--artifact-dir", required=True, help="Artifact directory containing verifier outputs.")
