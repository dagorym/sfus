...
- branded homepage at `/` describing the Milestone 3 content platform (blog, standalone pages, media, navigation, threaded comments), with a recent-posts feed and links to `/blog` and `/about`
